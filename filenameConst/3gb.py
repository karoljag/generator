#!/usr/bin/env python                               
# -*- coding: utf-8 -*-
                            #test importu 100 userów i dziecieciu lotów tych 100 userów na wszystkie  94 lotniska
import csv
import sys
import datetime
import os
...
try:
    ...
    for i in range(ileuserow):
           writer.writerow( ('U',userId+str(i),'2014-06-08 09:04:13','2016-02-13 00:00:00','2014-06-08 00:00:00','A','BB-01','BRB','westpalmbeach','0',userId+str(i),userId+str(i),userId+str(i),'westpalmbeach','Unknown','N','N','N','','JFK','','BGI','F','westpalmbeach','westpalmbeach','westpalmbeach','westpalmbeach@HOTMAIL.COM','25167','2014-05-09 00:00:00','2015-03-01 00:00:00','','','2014-03-16 00:00:00','','F','W','B6','','MR','','60 Simmons Road','cancun','','2417373','M','','','','','','','en-us','ENG','','F','','','','','','','','0'))
...
# --------------------------------------------------------------wszystkie loty miedzy lotniskami dla wszytskich userów razy dziesiec lotów-----------------
...
try:
    ...
    for de in dest : 
      for ie in dest :
        for iloscUsr in range (100):
          for ilosc in range (10): 
            writer.writerow((  'I','842166164','B6','12',userId+str(iloscUsr),'2015-02-03 00:00:00','2015-03-07 01:03:51','2015-02-02 00:00:00','2015-02-03 00:00:00','','17470','System','0','I','1','Y',de+ie,'seattle10','32F','32F658','B6','F','A','','','','','1922','','Salt Lake Support Center','ONGBGB','298.05','22.35','298.05','1000','1','A','4100003','8072','','','','2125457278','','N','QH00AE5U','Y','','','','','','','B6','8072','SLC','ORL','9010001','WEB - B2C / GUEST - USA','2015-01-08 00:00:00','279','QHIP','','','','','7664','L','P','','','','','','',))
    writer.writerow(('T',"94"))
finally:
...
usrPathToZIP = r'/home/soi/Pulpit/generator/dane/'+myDate+'/usr/'
tranPathToZIP = r'/home/soi/Pulpit/generator/dane/'+myDate+'/trn/'

shutil.make_archive(tranPathToZIP+myDate+'transactions', 'zip', tranPathToZIP)
shutil.make_archive(usrPathToZIP+myDate+'user', 'zip', usrPathToZIP)