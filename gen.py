...
try:
    ...
    for i in range(ileuserow):
     ...
     #   writer.writerow( ('U','testUser2','2014-06-08 09:04:13','2014-06-08 09:04:13','2014-06-08 09:04:13','A','BB-01','BRB',0,'seatingpref','seatingpref1','businFreq','pleasureFreq','Unknown','ccagr','N','N','N','JFK','CUN','ORD','ORD','M','Bobby','Kris','Brown','boob@migmail.pl'))
...
try:
    ...
    for i in range(ile):
      ...
      #  writer.writerow( ('U', 'DUPA%01d' % (i+1), '2014-06-08 09:04:13','2014-06-08 09:04:13','2014-06-08 09:04:13','A','BB-01','Cracov',0,'seatingpref','seatingpref1','businFreq','pleasureFreq','Unknown','ccagr','N','N','N','JFK','CUN','ORD','M','Bobby','Kris','Brown','boob@migmail.pl'))
          writer.writerow( ('I','842166164','B6','12','testUser2','2015-02-03 00:00:00','2015-02-03 00:00:00','2015-02-03 00:00:00', '2015-02-03 00:00:00','','17470','Sytem','0','I','1','Y','CURAUS','NewYork','32F','32F658','B6','F','A','','','','','1922','','Salt Lake Support Center','ONGBGB','298.05','22.35','298.05','1000','1','A','4100003','8072','','','','2125457278','','N','QH00AE5U','Y','','','','','','','B6','8072','SLC','ORL','9010001','WEB - B2C / GUEST - USA','2015-01-08 00:00:00','279','QHIP','','','','','7664','L','P','','','','','','',''))
